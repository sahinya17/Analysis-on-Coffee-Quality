...
```{r out.width = "100%", fig.width=10, fig.height=7, fig.cap= "The geographical location of the top3 countries which cultivated most kinds of Arabica coffee beans and Robusta coffee Beans respectively"}
# make a map
